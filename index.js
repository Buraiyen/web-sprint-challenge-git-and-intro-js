...
function getArtistByIndex(artistsArr, index) {
  /*Your Code Here*/
  const retrievedArtist = artistsArr[index];
  return `the artist at index ${retrievedArtist.id} is ${retrievedArtist.name}`
}
...
function listOfNames(artistsArr) {
  /*Your Code Here*/
  const arr = artistsArr;
  const artistNames = [];
...
function addArtist(artistsArr, name, years, genre, nationality, bio) {
  /*Your Code Here*/
  const newArtist = {
    name,
    years,
...
function lotsOfArt(artistsArr) {
  /*Your Code Here*/
  const artistsMoreThan100Paintings = [];
  for (let i = 0; i < artistsArr.length; i++) {
    if (artistsArr[i].paintings > 100) {
      console.log(artistsArr[i].name)
      artistsMoreThan100Paintings.push(artistsArr[i].name);
    }
  }
...
function artistInfo(artistsArr, artistName){
  /*Your Code Here*/
  for (let i = 0; i < artistsArr.length; i++) {
    if (artistsArr[i].name === artistName) {
      return artistsArr[i].bio;
    }
  }
}
...
function artistByCountry(artistsArr, nationality){
  /*Your Code Here*/
  const artistByCountryArr = [];
  for (let i = 0; i < artistsArr.length; i++) {
    if (artistsArr[i].nationality === nationality) {
      artistByCountryArr.push(artistsArr[i].name)
    }
  }
